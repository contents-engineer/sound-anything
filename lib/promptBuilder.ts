...
- "lyricsKr": 가사 언어가 "한국어"이면 정확히 빈 문자열 ""로 둡니다. 그 외(영어, 한국어+영어 섞어서, 직접입력 외국어 등)일 때는 lyrics의 한국어 번역을 같은 섹션 구조([Verse 1] 등)로 작성합니다. 단순 직역이 아니라 노래 가사 톤을 살린 의역(가창에 자연스러운 한국어)으로 다듬되, 의미와 정서는 원문과 일치시키세요. 섹션 라벨([Verse 1] 등)은 영문 그대로 둡니다.
